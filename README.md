[![CircleCI](https://circleci.com/gh/giantswarm/core-conversion-webhook.svg?style=shield)](https://circleci.com/gh/giantswarm/core-conversion-webhook)
...
See [Releases](https://github.com/giantswarm/core-conversion-webhook/releases)

## Contact

- Bugs: [issues](https://github.com/giantswarm/core-conversion-webhook/issues)
...
See [docs/Release.md](https://github.com/giantswarm/core-conversion-webhook/blob/master/docs/release.md)

## Add a new webhook

See [docs/webhook.md](https://github.com/giantswarm/core-conversion-webhook/blob/master/docs/webhook.md)

## Writing tests

See [docs/tests.md](https://github.com/giantswarm/core-conversion-webhook/blob/master/docs/tests.md)
