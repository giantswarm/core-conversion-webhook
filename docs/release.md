...
Follow CircleCI's progress in https://circleci.com/gh/giantswarm/core-conversion-webhook/.

## Edit the release draft and publish

Open the [release draft](https://github.com/giantswarm/core-conversion-webhook/releases/) on Github.
...
- `RELEASE_TOKEN` - A GitHub token with the permission to write to repositories
  - [giantswarm/core-conversion-webhook](https://github.com/giantswarm/core-conversion-webhook/)
